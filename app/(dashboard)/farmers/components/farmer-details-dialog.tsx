...
export function FarmerDetailsDialog({
  farmer,
  open,
  onOpenChange,
          ...
          <TabsContent value="bank" className="space-y-4">
            {farmer.bankDetails ? (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <InfoItem
                  label="Bank Name"
                  value={farmer.bankDetails.bankName}
                />
                <InfoItem
                  label="Branch Name"
                  value={farmer.bankDetails.branchName}
                />
                <InfoItem
                  label="IFSC Code"
                  value={farmer.bankDetails.ifscCode}
                />
                <InfoItem
                  label="Account Number"
                  value={farmer.bankDetails.accountNumber}
                />
                <InfoItem
                  label="Bank Code"
                  value={farmer.bankDetails.bankCode}
                />
            ...
            {farmer.documents ? (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <DocumentLink
                  ...
                  url={farmer.documents.profilePicUrl}
                />
                <DocumentLink
                  label="Aadhar Document"
                  url={farmer.documents.aadharDocUrl}
                />
                <DocumentLink
                  label="Bank Document"
                  url={farmer.documents.bankDocUrl}
                />
