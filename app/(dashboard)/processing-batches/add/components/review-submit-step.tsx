...
import type { Procurement } from "@fyzanshaik/chaya-prisma-package";
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Please review all details before creating the processing batch and its
          first stage (P1).
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-6">
        ...
        <div>
          <h3 className="text-lg font-semibold">
            Selected Procurements ({selectedProcurementIds.length})
          </h3>
          <Separator className="my-2" />
          ...
          <p className="font-semibold mt-2">
            Total Initial Batch Quantity: {totalInitialQuantity.toFixed(2)} kg
          </p>
        </div>
