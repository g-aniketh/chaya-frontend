...
export default function ProcurementsTable({
  ...
  const { fetchProcurements, prefetchPages, refreshCurrentPage } =
    ...
    try {
      ...
      const errorMessage =
        error instanceof Error
          ? error.message
          : "Failed to fetch procurements' data. Please try again.";
  ...
  const handleBulkDelete = async () => {
    ...
    try {
      ...
      const errorMessage =
        error instanceof Error
          ? error.message
          : "Failed to delete procurements. An unexpected error occurred.";
      toast.error(errorMessage);
    } finally {
      setIsDeleting(false);
    }
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              {selectedCount} procurement records and all associated data.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
