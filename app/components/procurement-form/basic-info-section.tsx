  ...
  useEffect(() => {
    if (watchedCrop) {
      ...
      if (
        ...
        !currentProcuredFormsForNewCrop.includes(currentProcuredFormValue)
      ) {
        setValue("procuredForm", "", { shouldValidate: true });
      } else if (
        !currentProcuredFormValue &&
        currentProcuredFormsForNewCrop.length > 0
      ) {
      ...
      <CardContent className="pt-6">
        <div className="space-y-4">
          ...
          <div>
            ...
            />
            {errors.crop && (
              <p className="text-sm text-red-500 mt-1">{errors.crop.message}</p>
            )}
          </div>
          <div>
