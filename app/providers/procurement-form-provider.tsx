...
const ProcurementFormContext = createContext<
  ProcurementFormContextType | undefined
>(undefined);
...
export function ProcurementFormProvider({
  children,
  initialData,
  mode,
}: ProcurementFormProviderProps) {
  ...
  return (
    <ProcurementFormContext.Provider value={{ mode, initialData }}>
      {children}
    </ProcurementFormContext.Provider>
  );
}
...
export function useProcurementFormContext() {
  ...
  if (context === undefined) {
    throw new Error(
      "useProcurementFormContext must be used within a ProcurementFormProvider"
    );
  }
  return context;
}
