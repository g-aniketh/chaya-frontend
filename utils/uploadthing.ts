...
const uploadHelpers: ReturnType<typeof generateReactHelpers<OurFileRouter>> =
  generateReactHelpers<OurFileRouter>();

export const useUploadThing: typeof uploadHelpers.useUploadThing =
  uploadHelpers.useUploadThing;
export const uploadFiles: typeof uploadHelpers.uploadFiles =
  uploadHelpers.uploadFiles;
